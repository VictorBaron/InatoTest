...
describe("Pharmacy", () => {
  ...
  describe("Classic drug", () => {
    it("should decrease the benefit and expiresIn", () => {
      expect(
        new Pharmacy([new DrugFactory("test", 1, 3)]).updateBenefitValue()
    ...
    describe("Expired", () => {
      it("should decrease the benefit twice and expiresIn", () => {
        expect(
          new Pharmacy([new DrugFactory("test", 0, 5)]).updateBenefitValue()
        ).toEqual([new DrugFactory("test", -1, 3)]);
      });

      it("should decrease expiresIn, benefit should not go under 0", () => {
        expect(
          new Pharmacy([new DrugFactory("test", 0, 1)]).updateBenefitValue()
        ).toEqual([new DrugFactory("test", -1, 0)]);
      });
    });
  });
  ...
  describe(drugs.HERBAL_TEA, () => {
    it("should increase the benefit and decrease expiresIn", () => {
      expect(
        new Pharmacy([
          new DrugFactory(drugs.HERBAL_TEA, 1, 3)
        ]).updateBenefitValue()
      ).toEqual([new DrugFactory(drugs.HERBAL_TEA, 0, 4)]);
    });
    ...
    describe("Expired", () => {
      it("should increase the benefit twice and decrease expiresIn", () => {
        expect(
          new Pharmacy([
            new DrugFactory(drugs.HERBAL_TEA, 0, 5)
          ]).updateBenefitValue()
        ).toEqual([new DrugFactory(drugs.HERBAL_TEA, -1, 7)]);
      });

      it("should decrease expiresIn, benefit should not go over 50", () => {
        expect(
          new Pharmacy([
            new DrugFactory(drugs.HERBAL_TEA, 0, 49)
          ]).updateBenefitValue()
        ).toEqual([new DrugFactory(drugs.HERBAL_TEA, -1, 50)]);
      });
    });
  });
  ...
  describe(drugs.MAGIC_PILL, () => {
    it("should be left unchanged", () => {
      expect(
        new Pharmacy([
          new DrugFactory(drugs.MAGIC_PILL, 1, 3)
        ]).updateBenefitValue()
      ).toEqual([new DrugFactory(drugs.MAGIC_PILL, 1, 3)]);
    });
  });
  ...
  describe(drugs.FERVEX, () => {
    describe("expires in more than 10 days", () => {
      it("should increase the benefit by 1 and decrease expiresIn", () => {
        expect(
          new Pharmacy([
            new DrugFactory(drugs.FERVEX, 15, 3)
          ]).updateBenefitValue()
        ).toEqual([new DrugFactory(drugs.FERVEX, 14, 4)]);
      });
    });
    describe("expires between 10 and 5 days", () => {
      it("should increase the benefit by 2 and decrease expiresIn", () => {
        expect(
          new Pharmacy([
            new DrugFactory(drugs.FERVEX, 10, 3)
          ]).updateBenefitValue()
        ).toEqual([new DrugFactory(drugs.FERVEX, 9, 5)]);
      });
    });
    describe("expires in less than 5 days", () => {
      it("should increase the benefit by 3 and decrease expiresIn", () => {
        expect(
          new Pharmacy([
            new DrugFactory(drugs.FERVEX, 5, 3)
          ]).updateBenefitValue()
        ).toEqual([new DrugFactory(drugs.FERVEX, 4, 6)]);
      });

      it("should decrease expiresIn, benefit should not go over 50", () => {
        expect(
          new Pharmacy([
            new DrugFactory(drugs.FERVEX, 2, 49)
          ]).updateBenefitValue()
